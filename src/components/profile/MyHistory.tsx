...
export default function MyHistory() {
  const playlists = [
    { id: 1, name: "Playlist_name", songs: 1, hasSuggestions: true },
    { id: 2, name: "Playlist_name2", songs: 1, hasSuggestions: true },
    { id: 3, name: "Playlist_name3", songs: 1, hasSuggestions: true },
  ];
